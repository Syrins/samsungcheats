...
//
//    const ImRect text_bb(window->DC.CursorPos + ImVec2(-1, style.FramePadding.y), window->DC.CursorPos + ImVec2(-1, style.FramePadding.y) + label_size);
//
//    if (label_size.x > 0) {
//
...
//        *v = !(*v);
//
//    auto borderColor = ImColor(216, 216, 216, 255);
//    auto topColor = ImColor(216, 216, 216, 255);
//    auto bottomColor = ImColor(216, 216, 216, 255);
//    auto topColorHovered = ImColor(216, 216, 216, 255);
//    auto bottomColorHovered = ImColor(216, 216, 216, 255);
//    auto checkedTopColor = ImColor(1, 1, 1, 255);
//    auto checkedBottomColor = ImColor(1, 1, 1, 255);
//
//    if (*v) {
...
//
//        window->DrawList->AddRectFilledMultiColor(check_bb.Min + ImVec2(6, 6), check_bb.Max - ImVec2(6, 6), checkedTopColor, checkedTopColor, checkedBottomColor, checkedBottomColor);
//    }
//    else {
//
//        if (hovered) {
...
//
//
//        RenderText(text_bb.Min + ImVec2(0.f, 0.f), label);
//    }
//
//    return pressed;
//}
...
//
//    const ImU32 frame_col = GetColorU32(g.ActiveId == id ? ImGuiCol_FrameBgActive : g.HoveredId == id ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg);
//    RenderFrame(ImVec2(frame_bb.Min.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / Center)), ImVec2(frame_bb.Max.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / Center)), frame_col, true, g.Style.FrameRounding);
//
//
//    window->DrawList->AddLine(ImVec2(frame_bb.Min.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / Center)), ImVec2(frame_bb.Max.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / Center)), ImColor(210, 210, 210), 3);
//
//    // Slider behavior
//    ImRect grab_bb;
...
//        MarkItemEdited(id);
//
//    //Drw our bar and circle 
//    //window->DrawList->AddLine(ImVec2(frame_bb.Min.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / Center)), ImVec2(grab_bb.Min.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / Center)), ImColor(94, 92, 179), 5);
//    window->DrawList->AddRectFilled(grab_bb.Min, grab_bb.Max, ImColor(1, 1, 1), style.GrabRounding);
//
//
//    return value_changed;
//}
